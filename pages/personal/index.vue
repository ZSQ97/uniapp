<template>
	<view class="page_content">
		...
		<view class="personal_list">
			<uni-list>
					  <uni-list-item :show-extra-icon="true" :extra-icon="extraIcon1" title="安全设置" clickable></uni-list-item>
					  <uni-list-item :show-extra-icon="true" :extra-icon="extraIcon1" title="退出登录" clickable></uni-list-item>
					</uni-list>
		</view>
	</view>
</template>
	...
	export default {
		data() {
			return {
				...
				bigIdx: 1,
				vips: [{
					bg: 'linear-gradient(94deg,rgba(118, 67, 168, 1.0),rgba(119, 93, 175, 1.0))',
					...
					bg: 'linear-gradient(94deg,rgba(136, 162, 168, 1.0),rgba(156, 177, 172, 1.0))',
					shadow: '0px 3px 12px 0px rgba(195,164,110,0.23)',
					title: '工艺规程',
					subTitle: '距离下一等级还差888积分'
				}, {
					bg: 'linear-gradient(94deg,rgba(192, 94, 96, 1.0),rgba(192, 130, 131, 1.0))',
					shadow: '0px 3px 12px 0px rgba(195,164,110,0.23)',
					title: '焊工证书',
					subTitle: '距离下一等级还差888积分'
				}, {
					bg: 'linear-gradient(94deg,rgba(69, 87, 168, 1.0),rgba(81, 96, 164, 1.0))',
					shadow: '0px 3px 12px 0px rgba(195,164,110,0.23)',
					title: '工作试件',
					subTitle: '距离下一等级还差888积分'
				}],
